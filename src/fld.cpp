...
void Fluid::initOutput(const char *dir, double tau0, char *suffix) {
 ...
 outy.append(suff);
 string outdiag = dir;
 outdiag.append("/outdiag");
 outdiag.append(suff);
 string outz = dir;
 outz.append("/outz");
 outz.append(suff);
 string outaniz = dir;
 outaniz.append("/out.aniz");
 outaniz.append(suff);
 string out2d = dir;
 out2d.append("/out2D");
 out2d.append(suff);
...
void Fluid::outputGnuplot(double tau) {
 ...
 for (int ix = 0; ix < nx; ix++) {
  ...
  fx << setw(14) << c->getpi(0, 3) << setw(14) << c->getpi(1, 1) << setw(14)
        << c->getpi(1, 2);
  fx << setw(14) << c->getpi(1, 3) << setw(14) << c->getpi(2, 2) << setw(14)
        << c->getpi(2, 3);
  fx << setw(14) << c->getpi(3, 3) << setw(14) << c->getPi() << setw(14)
 ...
 for (int iy = 0; iy < ny; iy++) {
  ...
  fy << setw(14) << c->getpi(0, 3) << setw(14) << c->getpi(1, 1) << setw(14)
        << c->getpi(1, 2);
  fy << setw(14) << c->getpi(1, 3) << setw(14) << c->getpi(2, 2) << setw(14)
        << c->getpi(2, 3);
  fy << setw(14) << c->getpi(3, 3) << setw(14) << c->getPi() << setw(14)
        << c->getViscCorrCutFlag() << endl;
 }
 fy << endl;
 ...
 for (int ix = 0; ix < nx; ix++) {
  ...
  fdiag << setw(14) << c->getpi(0, 3) << setw(14) << c->getpi(1, 1)
           << setw(14) << c->getpi(1, 2);
  fdiag << setw(14) << c->getpi(1, 3) << setw(14) << c->getpi(2, 2)
           << setw(14) << c->getpi(2, 3);
  fdiag << setw(14) << c->getpi(3, 3) << setw(14) << c->getPi() << setw(14)
           << c->getViscCorrCutFlag() << endl;
 }
 fdiag << endl;
 ...
 for (int iz = 0; iz < nz; iz++) {
  ...
  fz << setw(14) << c->getpi(0, 3) << setw(14) << c->getpi(1, 1) << setw(14)
        << c->getpi(1, 2);
  fz << setw(14) << c->getpi(1, 3) << setw(14) << c->getpi(2, 2) << setw(14)
        << c->getpi(2, 3);
  fz << setw(14) << c->getpi(3, 3) << setw(14) << c->getPi() << setw(14)
        << c->getViscCorrCutFlag() << endl;
 }
 fz << endl;
}
